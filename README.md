...
2   2   3
```
Note: Some functions are greedy, and prefer to evaluate immediately if the same function is seen before it. "^"  is such a function, as 2^2^3 evaluates to 2^(2^3) (using google's calculator.)
